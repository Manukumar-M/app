...
if(value!==undefined){params[paramKey]=value}}else if(dataType==='array'&&paramValue){try{params[paramKey]=JSON.parse(paramValue)}catch(err){}}else if(dataType==='object'&&paramValue){try{params[paramKey]=JSON.parse(paramValue)}catch(err){}}else if(dataType==='string'&&paramValue){params[paramKey]=paramValue}}
